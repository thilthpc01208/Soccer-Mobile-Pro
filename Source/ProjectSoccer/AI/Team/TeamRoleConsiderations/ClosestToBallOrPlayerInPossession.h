...
#include "ClosestToBallOrPlayerInPossession.generated.h"

UCLASS()
class PROJECTSOCCER_API UClosestToBallOrPlayerInPossession : public UBooleanConsideration, public ITeamRoleScoreProvider
{
	GENERATED_BODY()
